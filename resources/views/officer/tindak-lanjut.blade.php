	...
	<div class="row" style="min-height: calc(100vh - 100px);">
				...
				<div class="card-body d-flex flex-column" style="gap:1.5rem;">
					...
					@else
						<div id="detail-tiket-card" class="mb-3">
							<div class="row g-3">
								<div class="col-md-6">
									<div class="flip-card" id="ticket-flip-officer" role="button" tabindex="0" title="Klik untuk melihat informasi pelapor">
		...
		<div class="col-lg-3 d-flex flex-column" style="gap:1.5rem;">
			<div class="card flex-fill h-100" id="chat-card">
				...
				<div class="card-body p-2 d-flex flex-column" style="height:520px; box-sizing:border-box;">
					@if(!empty($ticket))
						...
						<div class="chat-controls mt-2" style="flex:0 0 auto;">
							<div class="card">
								<div class="card-body py-2 d-flex align-items-center" style="gap:.5rem;">
									<button id="btn-attach" type="button" class="btn btn-outline-secondary" title="Lampiran" aria-label="Lampiran" style="width:44px;height:44px;padding:0;border-radius:8px;">
									...
									<button id="btn-send" type="button" class="btn btn-primary" title="Kirim" aria-label="Kirim" style="width:44px;height:44px;padding:0;border-radius:8px;">
										<svg style="width:20px;height:20px;display:block;margin:auto;" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
